  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute w-96 h-96 bg-primary/15 rounded-full blur-[80px] -top-20 -left-20" />
        <div className="absolute w-80 h-80 bg-purple-600/15 rounded-full blur-[80px] bottom-10 right-10" />
      </div>
          ...
          <div className="flex items-center gap-3">
            <div className="relative hidden lg:block">
              ...
              <input
                ...
                className="glass-input rounded-full pl-10 pr-4 py-2 text-sm w-64 placeholder:text-white/20"
              />
            </div>
            <button className="size-10 glass-panel rounded-full flex items-center justify-center hover:bg-white/10 transition-colors">
